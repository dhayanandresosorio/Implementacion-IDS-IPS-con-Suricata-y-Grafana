...
La máquina Suricata actúa como router entre dos subredes, analiza el tráfico en modo IDS y después se configura en modo IPS para bloquear tráfico mediante reglas locales. Finalmente, los eventos generados se envían a Loki mediante Alloy y se visualizan en Grafana mediante dashboards.
